...
หากต้องการให้ AI agent ใด ๆ เช่น Claude, Gemini, Codex หรือ Antigravity นำความสามารถเหล่านี้มาพัฒนาฟีเจอร์ของ **BUYMORE ERP** ได้ดีที่สุด ให้ใส่ความคาดหวังและพิกัดลงในคำสั่งหรือพิมพ์ในหน้าแชทดังนี้:

### คำสั่งสำหรับจัดทำแผนงาน (Architect role):
...
### คำสั่งสำหรับให้ลงมือทำ (Implementer role):
