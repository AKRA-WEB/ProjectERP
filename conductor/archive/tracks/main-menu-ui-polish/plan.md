...
- [x] อ่านไฟล์โค้ด `app/app/menu/page.tsx` เพื่อตรวจสอบการดึง Permission และโครงสร้างปัจจุบัน
- [x] อัปเดต CSS และ CSS variables สำหรับ `--accent` สีเฉพาะตัวในหน้า `app/app/menu/page.tsx`
- [x] พัฒนาโมดูลจำลอง (Stubs) สำหรับ ขาย (Sales) และ จัดซื้อ (Purchasing) พร้อม Toast แจ้งเตือนเมื่อคลิก
- [x] ปรับดีไซน์ Card Layout ให้กว้าง 172px และความสูงแนวตั้งตามสัดส่วนที่ถูกต้อง
- [x] เพิ่ม Top Accent Bar และ Hover Effects ให้ลื่นไหล มี Micro-animations
- [x] อัปเดต Footer เป็น `v 2.4` 
- [x] ทดสอบความถูกต้องด้วย `npx tsc --noEmit`
- [x] ทดสอบการแสดงผลบนหน้าจอ ขนาดต่างๆ (Responsive)
