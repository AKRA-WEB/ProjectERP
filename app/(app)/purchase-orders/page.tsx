            ...
            {loading ? (
              ...
              data?.data.map((po) => (
                <tr key={po.id} className="hover:bg-gray-50">
                  ...
                  <Td className="text-sm">{po.vendor_code} — {po.vendor_name}</Td>
                  <Td className="text-sm">{po.warehouse_code}</Td>
                  <Td className="text-sm text-right font-medium">{formatCurrency(po.total_amount)}</Td>
                  <Td className="text-sm">{po.expected_date ? formatDate(po.expected_date) : '—'}</Td>
                  <Td><StatusBadge status={po.status} /></Td>
                  <Td className="text-sm text-gray-500">{formatDate(po.created_at)}</Td>
                  <Td>
