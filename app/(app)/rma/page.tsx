  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="/app/rma/new"><Button>+ สร้าง RMA</Button></Link>
      </div>
      ...
      <div className="rounded-xl bg-white shadow-sm border border-gray-100">
        <Table>
          <Thead>
            <tr><Th>เลข RMA</Th><Th>ผู้จำหน่าย</Th><Th>คลัง</Th><Th>ผู้แจ้ง</Th><Th>รายการ</Th><Th>สถานะ</Th><Th>วันที่</Th><Th></Th></tr>
          </Thead>
          <Tbody>
            {loading ? (
              ...
              <tr key={r.id} className="hover:bg-gray-50">
                ...
                <Td className="text-sm">{r.vendor_code} — {r.vendor_name}</Td>
                <Td className="text-sm">{r.warehouse_code}</Td>
                <Td className="text-sm">{r.initiated_by_name}</Td>
                <Td className="text-sm text-center">{r.line_count}</Td>
