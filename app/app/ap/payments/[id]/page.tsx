...
export default function ApPaymentDetailPage() {
  ...
  if (!payment) return <div className="py-16 text-center text-stone-600">ไม่พบข้อมูลการชำระเงิน</div>;
    ...
    <div className="max-w-4xl mx-auto pb-12 space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col items-end">
          <p className="text-xs text-stone-600 uppercase tracking-widest mb-1">ยอดชำระรวม</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className={`${CARD} p-6`}>
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-6">
              ...
              <div>
                <p className="text-xs text-stone-600 mb-1">วันที่ชำระเงิน</p>
                <p className="text-sm font-medium">{formatDate(payment.payment_date)}</p>
              </div>
              <div>
                <p className="text-xs text-stone-600 mb-1">อ้างอิงธนาคาร / Ref.</p>
                <p className="text-sm font-medium font-mono">{payment.bank_ref || '—'}</p>
              </div>
              <div>
                <p className="text-xs text-stone-600 mb-1">ผู้บันทึกรายการ</p>
                <p className="text-sm font-medium">{payment.paid_by_name}</p>
              </div>
            </div>
            {payment.notes && (
              <div className="mt-4 pt-4 border-t border-stone-50">
                <p className="text-xs text-stone-600 mb-1">หมายเหตุ</p>
        ...
        <div className="space-y-6">
          <div className={`${CARD} p-6`}>
            <h3 className="text-xs font-bold text-stone-600 uppercase tracking-widest mb-4">ประวัติการทำรายการ</h3>
            <div className="relative pl-4 border-l border-stone-200 space-y-6">
              <div className="relative">
                ...
                <p className="text-[11px] text-stone-600 mt-1">{formatDate(payment.created_at)}</p>
