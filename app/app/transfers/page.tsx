  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link href="/app/transfers/new"><Button className="w-full sm:w-auto">+ สร้างการโอน</Button></Link>
      </div>
          ...
          <Tbody>
            {loading ? (
              ...
              <tr key={t.id} className="hover:bg-gray-50">
                ...
                <Td className="text-sm hidden sm:table-cell">{t.source_code} โ€” {t.source_name}</Td>
                <Td className="text-sm hidden sm:table-cell">{t.dest_code} โ€” {t.dest_name}</Td>
