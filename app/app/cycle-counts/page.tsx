  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link href="/app/cycle-counts/new"><Button className="w-full sm:w-auto">+ สร้างการนับ</Button></Link>
      </div>
          ...
          <Tbody>
            {loading ? (
              ...
              <tr key={cc.id} className="hover:bg-gray-50">
                ...
                <Td className="text-sm hidden sm:table-cell">{cc.warehouse_code} โ€” {cc.warehouse_name}</Td>
